...
.elgg-walledgarden-double > .elgg-body {
	background: url(<?php //echo $url; ?>_graphics/walled_garden/two_column_middle.png) no-repeat left top;
}
...
.elgg-walledgarden-single > .elgg-body {
	background: url(<?php // echo $url; ?>_graphics/walled_garden/one_column_middle.png) no-repeat left top;
}
